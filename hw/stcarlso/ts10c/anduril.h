// stcarlso's TS10C "FLARE 1" driver
// Copyright (C) 2025 stcarlso, Selene ToyKeeper
// SPDX-License-Identifier: GPL-3.0-or-later
#pragma once

#define HWDEF_H stcarlso/ts10c/hwdef.h
...
//   - high 2.5  V
// HDR ratio: 143
// level_calc.py 4.3287 1 150 7135 1 0.01 2000 --pwm 425000

// top level for each "gear": 30 39 120 150
#define PWM1_LEVELS \
           1,   2,   4,   6,   9,  12,  17,  23,  30,  38,  48,  59,  73,  89, 108, 130, 155, 183, 215, 251, 291, 336, 387, 443, 506, 574, 650, 733, 825, 924, \
         423, 471, 524, 581, 643, 709, 781, 858, 941, \
          14,  16,  17,  19,  20,  22,  24,  26,  28,  30,  33,  35,  38,  41,  44,  47,  50,  54,  58,  61,  66,  70,  74,  79,  84,  89,  95, 100, 106, 112, 119, 125, 132, 140, 147, 155, 164, 172, 181, 190, 200, 210, 220, 231, 242, 254, 266, 278, 291, 304, 318, 332, 347, 362, 378, 394, 411, 428, 446, 465, 484, 503, 524, 545, 566, 588, 611, 634, 659, 683, 709, 735, 762, 790, 819, 848, 878, 909, 941, 974,1007, \
...
#define MAX_1x7135            39
#define HDR_ENABLE_LEVEL_MIN  40

// no PWM, so MCU clock speed can be slow
#define HALFSPEED_LEVEL      40
#define QUARTERSPEED_LEVEL   39
