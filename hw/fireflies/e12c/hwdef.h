...
// Copyright (C) 2019-2023 Selene ToyKeeper, Loneoceans
...
#define HWDEF_C  fireflies/e12c/hwdef.c
...
#define PWM2_DATATYPE uint8_t   // 11x7135 ramp
...
// 7x7135 channel
#define CH2_PIN  PB1        // pin 6, 11x7135 PWM
