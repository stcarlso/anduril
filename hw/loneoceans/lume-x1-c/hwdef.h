...
//**************************************************
//**  HARDWARE DEFINITIONS FOR LUME-X1-C          **
//**************************************************
...
#define HWDEF_C  loneoceans/lume-x1-c/hwdef.c
...
/* 
    ...
    on the order of >50-100 million : 1. 
*/
...
inline void hwdef_setup() {
    ...
    //PORTD.PIN4CTRL = PORT_PULLUPEN_bm;  // ESW (EXT PULLUP)
