// Lume1 driver layout (attiny1634)
// Copyright (C) 2020-2023 Selene ToyKeeper, Loneoceans
// SPDX-License-Identifier: GPL-3.0-or-later
#pragma once

//*********************************************
//**  HARDWARE DEFINITIONS FOR LUME1-2020    **
//*********************************************

/* Loneoceans Lume1 with ATTINY1634
 * Pin / Name / Function
 ...
 * one pin to control the power level via PWM with DSM. 
...
inline void hwdef_setup() {
    ...
    // FET PWM Pin
    DDRB = (1 << CH2_PIN);
    // Main PWM, Buck Enable Pin, aux R/G/B
    DDRA = (1 << CH1_PIN)
         | (1 << CH1_ENABLE_PIN)
         | (1 << AUXRGB_R_PIN)
         | (1 << AUXRGB_G_PIN)
